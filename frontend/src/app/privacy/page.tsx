  ...
  return (
    <div className="space-y-6 pb-16">
      ...
      <Section title="7. 미성년자 보호">
        <p>서비스는 미성년 이용자를 보호하기 위해 다음 조치를 적용합니다.</p>
        <ul className="list-disc pl-5 space-y-1">
          <li>만 14세 미만은 회원가입이 제한됩니다.</li>
          <li>
            만 14세 이상 미성년 이용자에게는 자존감을 해치지 않는 범위의 건설적인 코멘트만 제공하며,
            매운맛(직설적 독설) 평가를 적용하지 않습니다.
          </li>
          <li>
            미성년 이용자는 신체 점수를 서로 비교하는 <span className="text-text-primary">경쟁(랭킹) 기능에서 제외</span>되며,
            다른 이용자의 순위표에도 점수가 노출되지 않습니다.
          </li>
          <li>분석 결과 화면에 성장기 체형 변화에 대한 안내를 함께 제공합니다.</li>
        </ul>
      </Section>
